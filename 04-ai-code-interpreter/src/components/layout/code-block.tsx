...
export function CodeBlock({
  ...
  return (
    <div className="group relative my-2 overflow-hidden rounded-lg border border-border">
      <div className="flex items-center justify-between border-b border-border bg-gray-100 px-3 py-2">
        <span className="text-xs text-muted-foreground tracking-normal capitalize">
          {language ?? "text"}
        </span>
        <button
          type="button"
      ...
      {html ? (
        <div
          className={cn(
            "overflow-x-auto text-[13px] [&_pre]:p-3 [&_pre]:bg-transparent!",
          )}
